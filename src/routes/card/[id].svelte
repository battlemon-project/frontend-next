...
{#if nft && nftOnSale !== null } 
  <section class="row">
    <div class="col-md-6 position-relative">
      <div class="img-box" style="margin: -70px 0 -50px">
