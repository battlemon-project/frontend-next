...
<section class="card">
  <div class="preview">
    <div class="img-box">
      <picture class="lazy">
        <img src="/img/fighters-27.png" alt="Battle lemon" />
      </picture>
    </div>
  ...
  <ul class="collection-list">
    ...
    <li>
      <div class="card-preview">
        <div class="img-box">
          <picture class="lazy">
            <img src="/img/fighters-24.png" alt="Card" />
          </picture>
        </div>
        <a href={"#"}>&nbsp;</a>
      </div>
    ...
    <li>
      <div class="card-preview">
        <div class="img-box">
          <picture class="lazy">
            <img src="/img/fighters-25.png" alt="Card" />
          </picture>
        </div>
        <a href={"#"}>&nbsp;</a>
      </div>
    ...
    <li>
      <div class="card-preview">
        <div class="img-box">
          <picture class="lazy">
            <img src="/img/fighters-26.png" alt="Card" />
          </picture>
        </div>
        <a href={"#"}>&nbsp;</a>
      </div>
